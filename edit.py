...
cnx = sql.connect(user='root', password='mysql', host='localhost', database='stock')
cursor = cnx.cursor()
...
def update_product():
    ...
    update_product_query = "UPDATE product SET product_name=%s WHERE quantity=%s AND product_id=%s"
